Public Class FormMenu
    ...
    Private Sub MerkHandphoneToolStripMenuItem_Click(sender As Object, e As EventArgs)
        'FormMerkHp.Show()
    End Sub
    ...
    Private Sub DataHandphoneToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles DataMobilToolStripMenuItem.Click
        FormMobil.Show()
    End Sub
